...
/**
 * Resolve a string or `Model` constructor into a `Model` constructor.
 * @param {String|Function} name
 * @returns {Function} The `Model` constructor
 */

Registry.prototype.resolveModel = function(name) {
  switch (typeof name) {
    case 'string':
      return registry.findModel(name);
    break;
    case 'function':
      return name;
    break;
